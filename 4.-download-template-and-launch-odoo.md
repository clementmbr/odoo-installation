...
1. Open a  `byobu` session
2. Go to your Odoo project folder
3. Launch docky with `docky run`
4. Inside your docky container, launch Odoo with the same installation command you lastly used, for instance :
